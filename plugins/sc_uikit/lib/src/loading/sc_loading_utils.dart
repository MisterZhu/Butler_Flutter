...
class SCLoadingUtils {
  ...
  static initLoading() {
    ...
    EasyLoading.instance.successWidget = SizedBox(
      width: 24.0,
      height: 24.0,
      child: Image.asset('images/loading/icon_success_white.png', width: 24.0, height: 24.0,),
    );
    EasyLoading.instance.errorWidget = SizedBox(
      width: 24.0,
      height: 24.0,
      child: Image.asset('images/loading/icon_failed_white.png', width: 24.0, height: 24.0,),
    );
  }
