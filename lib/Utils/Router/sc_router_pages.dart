...
import 'package:smartcommunity/Page/ApplicationModule/WarningCenter/Page/sc_warning_search_page.dart';
...
import '../../Page/ApplicationModule/Patrol/Page/sc_patrol_route_page.dart';
import '../../Page/ApplicationModule/Patrol/Page/sc_task_log_page.dart';
import '../../Page/ApplicationModule/Patrol/bind/sc_patrol_route_bind.dart';
...
class SCRouterPages {
  ...
  static final List<GetPage> getPages = [
    ...
    /*巡查*/
    GetPage(name: SCRouterPath.patrolPage, page: () => SCPatrolPage()),
    /*任务日志*/
    GetPage(name: SCRouterPath.taskLogPage, page: () => SCTaskLogPage()),
    /*巡查详情*/
    ...
    GetPage(name: SCRouterPath.patrolCheckCellEditPage, page: () => SCCheckCellEditPage()),
