...
class SCKey {
  ...
  /// 是否显示设置通知提示弹窗
  static const String kIsShowSetNotificationAlert = "kIsShowSetNotificationAlert";
  /// 建信租房应用token
  ...
  /// 仓储-刷新资产维保页面
  static const String kRefreshPropertyMaintenancePage = "kRefreshPropertyMaintenancePage";
  /// 预警中心-刷新页面
