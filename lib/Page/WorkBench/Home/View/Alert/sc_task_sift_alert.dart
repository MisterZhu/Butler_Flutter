...
class SCTaskSiftAlert extends StatefulWidget {
  ...
  /// 编辑我的任务
  final Function? editMyTaskAction;
...
class SCTaskSiftAlertState extends State<SCTaskSiftAlert> {
  ...
  Widget sectionTitle(int index) {
    bool canEditMyTask = widget.canEditMyTask ?? false;
    return Row(
      ...
      children: [
        ...
        Offstage(
          offstage: !(canEditMyTask && index == 0),
          child: SizedBox(
            height: 18.0,
            child: CupertinoButton(
                ...
                child: const Text(
                  '编辑',
                  style: TextStyle(
                      fontSize: SCFonts.f14, color: SCColors.color_1B1D33),
                ),
                onPressed: () {
                  widget.editMyTaskAction?.call();
                }),
          ),
        )
      ],
