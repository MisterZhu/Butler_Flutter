...
import '../../MaterialOutbound/Controller/sc_material_outbound_controller.dart';
import '../../MaterialOutbound/View/Alert/sc_outbound_confirm_alert.dart';
import '../Controller/sc_propertymaintenance_detail_controller.dart';

/// 资产维保详情

class SCPropertyMaintenanceDetailPage extends StatefulWidget {
  @override
  SCPropertyMaintenanceDetailPageState createState() => SCPropertyMaintenanceDetailPageState();
}
...
class SCPropertyMaintenanceDetailPageState extends State<SCPropertyMaintenanceDetailPage> {
  ...
  @override
  dispose() {
    SCScaffoldManager.instance.deleteGetXControllerTag((SCPropertyMaintenanceDetailPage).toString(), controllerTag);
    controller.dispose();
    super.dispose();
  }
