...
class SCPropertyRecordView extends StatefulWidget {

  /// SCPropertyRecordController
  final SCPropertyRecordController state;

  SCPropertyRecordView({Key? key, required this.state}) : super(key: key);

  @override
  SCPropertyRecordViewState createState() => SCPropertyRecordViewState();
}

class SCPropertyRecordViewState extends State<SCPropertyRecordView> {
  ...
  /// 新增出库按钮
  Widget addItem() {
    return SCAddEntryButton(name: '新增维保', tapAction: () {
      SCRouterHelper.pathPage(SCRouterPath.addPropertyRecordPage, null);
    },);
  }
