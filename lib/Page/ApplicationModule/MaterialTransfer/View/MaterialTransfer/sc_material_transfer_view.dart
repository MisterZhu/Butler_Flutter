...
class SCMaterialTransferView extends StatefulWidget {
  ...
  @override
  SCMaterialTransferViewState createState() => SCMaterialTransferViewState();
}

class SCMaterialTransferViewState extends State<SCMaterialTransferView> {
  ...
  /// 新增调拨按钮
  Widget addItem() {
    return SCAddEntryButton(name: '新增调拨', tapAction: () {
      SCRouterHelper.pathPage(SCRouterPath.addTransferPage, null);
    },);
  }
