...
import 'package:smartcommunity/Page/ApplicationModule/FixedCheck/Controller/sc_add_fixedcheck_controller.dart';
...
class SCAddFixedCheckView extends StatefulWidget {
  /// SCAddFixedCheckController
  final SCAddFixedCheckController state;
  ...
  @override
  SCAddFixedCheckViewState createState() => SCAddFixedCheckViewState();
}

class SCAddFixedCheckViewState extends State<SCAddFixedCheckView> {
  /// 处理人
