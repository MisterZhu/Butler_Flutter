...
class SCTaskCardCell extends StatelessWidget {

  /// 类型，0显示年月日 时分秒，1显示时间差
  final int type;
      ...
      if (remainingTime > 0) {
        return Row(
            ...
            children: [
              ...
              const SizedBox(width: 6.0,),
              Expanded(child: SCTaskTimeItem(time: remainingTime),)
            ]
        );
      } else {
